...
import { SourceDescription } from '@ntrp/ksqldb-client/dist/types/api/ksql/source-description';
import { Field } from '@ntrp/ksqldb-client/dist/types/api/ksql/field';
...
export const buildKsqlDBGraphQL = (options: Config): Promise<{
  schemas: any;
  queryResolvers: any;
